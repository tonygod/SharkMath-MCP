...
try:
    ...
    from . import calculate_geometry_3d  # Consolidated: 3D geometry calculations (14 functions → 1 tool)
    ...
    import calculate_geometry_3d  # Consolidated: 3D geometry calculations (14 functions → 1 tool)
...
calculate_geometry_3d.register_tools(mcp)  # Consolidated: calculate_geometry_3d (3D distance, vectors, volumes, surface areas)
